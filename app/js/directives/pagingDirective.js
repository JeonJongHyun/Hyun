...
//-----------------------------------------------------------------------------
myDirectiveModule.controller('myPaginationController', ['$scope', '$location','$attrs', '$parse','$http', 'HttpService', 'messageService',
...
myDirectiveModule.directive('myPaginationDirective', function() {
    ...
    return {
        restrict: 'E',
        templateUrl: 'js/directives/pagination_template.html',
