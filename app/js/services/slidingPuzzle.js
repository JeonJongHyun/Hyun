var gameService = angular.module('MyApp');


    /**
     * Service
     */
    gameService.factory('slidingPuzzle', function($rootScope, $http, $location) {
        function shuffle(a) {
            var q;
        ...
        function SlidingPuzzle(rows, cols) {
            ...
            this.move = function(srow, scol) {
                ...
                $http.post('/game/insert', {tel:$rootScope.currentUser.tel,name:$rootScope.currentUser.name,moves:this.moves})
     ...
     * Directive
     */
    gameService.directive('slidingPuzzle', function(slidingPuzzle) {
        return {
            restrict: 'EA',
            replace: true,
